...
const Storyblok = new StoryblockClient({accessToken:'T8mLujNezqZvQjHW6yF0Xwtt'})
export default {
  name: "Home",
  components: {
    Hero,
  ...
  mounted() {
    this.data = axios.get(Storyblok.get('cdn/stories/hero', {version:'draft'})).then(response => (this.data = response.data.story.content))
    // axios
