<template>
  <div class="container">
    ...
    <form @submit.prevent="sendEmail">
      ...
      <div :class="{ 'checkbox-div': initialData.isSend }">
        <input
          type="checkbox"
          name="checkbox"
          class="checkbox"
        ...
        <label for="" class="checkbox-label">
         <router-link to="/cookiepage"> Súhlasím so spracovaním osobných údajov </router-link></label
        >
      </div>

      <div :class="{ active: initialData.isSend && !isChecked}">
        <p class="item">Zaškrnite políčko zo spracovaním osobných údajov</p>
      </div>

      <div :class="{ active: initialData.isSend }">
