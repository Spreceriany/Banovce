<template>
  <div class="people-container">
    <div class="image">
      <img src="../assets/meeting.png" alt="meeting image" class="reveal-image" />
    </div>
    <div class="text">
      <span>O nás</span>
      <h2>Náš príbeh</h2>
  ...
  <div class="people-container right">
    <div class="image">
      <img src="../assets/meeting2.png" alt="meeting image 2" class="reveal-image"/>
    </div>
    <div class="text">
      <span>O nás</span>
      <h2>Náš príbeh</h2>
  ...
  mounted(){
    ...
    const tl = gsap.timeline({
      ...
      tl.from([container, image], {
        duration: 1,
        xPercent:
        i % 2 === 0 ? gsap.utils.wrap([-100, 100]) : gsap.utils.wrap([100, -100]),
        ease: "power4"
      });
