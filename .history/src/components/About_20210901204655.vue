...
export default {
  name: "About",
   ...
   mounted() {
    axios
      .get('https://api.storyblok.com/v2/cdn/stories/domovska-stranka-o-nas?version=draft&token=ULhggiK1mlwtAQretJ4Snwtt')
      .then(response => (this.data = response.data.story.content)).then( () =>{
            const t1 = gsap.timeline();
        gsap.set(".rightt",{autoAlpha:1})
        t1.from(".left", {
          opacity: 0,
          y: 80,
          ease: "power4.out",
