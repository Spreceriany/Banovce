      ...
      <form  @submit.prevent="sendEmail">
        ...
        <div class="form-row">
          <div class="input-data textarea">
            <textarea rows="10" cols="100" name="message" required v-model="message"></textarea>
            <div class="underline"></div>
        ...
        <div class="form-row">
          <input type="checkbox" name="checkbox" id="" class="checkbox" v-model="checked">
          <label for="" class="checkbox-label"> Súhlasím so spracovaním osobných údajov {{checked}}</label>
        </div>
