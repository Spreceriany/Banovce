    ...
    <div class="container">
      ...
      <form  @submit.prevent="sendEmail">
        <div class="form-row">
          ...
          <div class="input-data">
            <input type="text" required v-model="email" name="email"/>
            <div class="underline"></div>
            <label for="">Email</label>
          </div>
             <div class="input-data">
            <input type="text" required v-model="phone" name="phone"/>
            <div class="underline"></div>
        ...
        <div class="form-row">
          <div class="input-data textarea">
            <textarea rows="10" cols="100" required v-model="message"></textarea>
            <div class="underline"></div>
